...
public class DailyChartReports {
    ...
    public DailyChartReports() {
    }

    public DailyChartReports(Double hour2, Double hour4, Double hour6, Double hour8, Double hour10, Double hour12, Double hour14, Double hour16, Double hour18, Double hour20, Double hour22, Double hour24) {
        this.hour2 = hour2;
        this.hour4 = hour4;
        this.hour6 = hour6;
        this.hour8 = hour8;
